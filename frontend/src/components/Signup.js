...
function Signup( ) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                window.location.href = '/'; // Redirect to dashboard after successful signup
            } else {
    ...
    return (
        <div className="flex h-screen bg-zinc-200 items-center justify-center">
            <div className="bg-white px-32 py-10 rounded shadow-md w-100">
                <h2 className="text-2xl mb-4 font-semibold font-mono text-center">Sign Up</h2>
